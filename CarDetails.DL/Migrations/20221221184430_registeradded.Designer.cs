...
namespace CarDetails.DL.Migrations
{
    ...
    [Migration("20221221184430_registeradded")]
            ...
            modelBuilder.Entity("CarDetails.DL.Models.Car", b =>
                {
                    ...
                    b.Property<string>("CarDetailTitle")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("CarDetails.DL.Models.Comment", b =>
                {
                    ...
                    b.HasIndex("_UserUserId");

                    b.ToTable("Comment");
                });

            modelBuilder.Entity("CarDetails.DL.Models.UserModel", b =>
                {
                    b.Property<int>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CarDetails.DL.Models.Comment", b =>
                {
                    ...
                    b.HasOne("CarDetails.DL.Models.UserModel", "_User")
                        .WithMany()
                        .HasForeignKey("_UserUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
